...
switch p.fit.PFtype 
    case 'gumbel'
        stimLevels = log(a.contrasts_postcue); % log space (log10) 
    case 'weibull'
        stimLevels = a.contrasts_postcue; % linear space <-- here subtract 1 pix? 
end
...
for iAtt = 1:numel(a.attHeaders)
    ...
    switch taskType
        case 'subjective',      searchGrid.gamma = 0; % guess-rate should be 0 --> 0.5 for stronger/weaker than ref?
